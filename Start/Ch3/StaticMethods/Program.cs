...
//Console.WriteLine($"{Temperature.CtoF(1.0):F2}");
//Console.WriteLine($"{Temperature.FtoC(21.0):F2}");
...
Console.WriteLine($"{Temperature.IsRoomTemp(0.0)}");
Console.WriteLine($"{Temperature.IsRoomTemp(23.0)}");